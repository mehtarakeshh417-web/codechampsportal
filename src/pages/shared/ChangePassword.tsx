  ...
  return (
    <div>
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
        <h1 className="font-display text-3xl font-bold mb-1 text-white"><span className="text-gradient-brand">{roleLabel}</span> Change Password</h1>
        <p className="font-body mb-8 text-primary-foreground">Update your account password</p>
      </motion.div>
